...
public class E2E_Contact {
    ...
    public void should_add_contact(String fname, String lname, String birthdate, String email, String phone, String street1, String street2, String city, String state, String postalCode, String country) throws IOException {
        //Arrange
    ...
    @Test(priority = 3)
    public void should_get_contact() throws IOException {
        //Arrange
        req = given().spec(globalProperties.getReq()
                .header("Authorization","Bearer "+loginToken));
        ...
        System.out.println(apiResources.getResource());
        //Act
        response = req.when().get(apiResources.getResource()+_id).then().extract().response();
